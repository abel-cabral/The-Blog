...
CREATE TABLE `comentario` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_comment_article1_idx` (`id_artigo`) USING BTREE,
  KEY `fk_articles_users1_idx` (`id_usuario`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `cadastro_aprovado` varchar(1) NOT NULL DEFAULT 'N',
  PRIMARY KEY (`id`)
...
INSERT INTO `usuario` (`id`, `email`, `senha`, `nome`, `cpf`, `papel`, `cadastro_aprovado`) VALUES
(1, 'login@usuario.com', '111', 'admin', '249.252.810-38', 0, 'S');
